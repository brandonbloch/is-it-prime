...
export function App() {
  ...
  const onmessage = useCallback((e: MessageEvent<CheckPrimeResponse | CheckPrimeProgress>) => {
  ...
  const onChange = useCallback((e: ChangeEvent<HTMLInputElement>) => {
    ...
    setInput(newInput);
    const newValue = Number.parseInt(newInput);
    const newIsValid = !Number.isNaN(newValue) &&
